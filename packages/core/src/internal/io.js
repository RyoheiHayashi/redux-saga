...
import { identity, check, createSetContextWarning, object } from './utils'
...
export const detach = eff => {
  ...
  const detachedPayload = object.assign({}, eff.payload, { detached: true })
  return makeEffect(effectTypes.FORK, detachedPayload)
}
